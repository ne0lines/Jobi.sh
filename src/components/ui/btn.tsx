...
const variantClassNames: Record<BtnVariant, string> = {
  ...
  red:
    "bg-gradient-to-r from-app-red to-app-red-strong text-white shadow-lg visited:text-white",
};
...
export function Btn({
  ...
  if (typeof props.href === "string") {
    ...
    if (isExternal) {
      return (
        <a className={classes} href={href} rel={rel} style={resolvedStyle} target={target}>
          {content}
        </a>
      );
    }
